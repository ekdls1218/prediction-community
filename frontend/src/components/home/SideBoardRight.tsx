        ...
        <div className="w-1/5 h-full bg-white border-2 border-gray-200 rounded-xl p-3">
            <div>
                ...
                {postVoteRank.map((r,i) => {
                    return(
                        <div key={i} className="border-2 border-gray-100 text-center shadow-sm rounded-md px-1 py-1 bg-white mb-2">
                            <span className="block text-xs text-gray">{i+1}등</span>
                            <span className="text-primary-color text-sm font-bold mb-2">
                            {r.title}
                            </span>
                        </div>
                    )
